...
root.title("NFTs Upload to OpenSea v1.0")
...
def main_program_loop():
 ###START###
    ...
    while end_num >= start_num:
        ...
        if is_polygon.get():
            # blockchain_button = driver.find_element(By.XPATH, '//*[@id="chain"]')
            # driver.execute_script("arguments[0].click();", blockchain_button)
            # time.sleep(0.8)
            
            # select_polygon = driver.find_element(By.XPATH, "/html/body/div[1]/div[1]/main/div/div/section/div[2]/form/div[7]/div/div[3]/div/div/div/ul/li/button")
            # select_polygon.click()
            ...
            # blockchain_button.send_keys(Keys.TAB)
            # time.sleep(0.8)
            # blockchain_button.sendKeys(Keys.ENTER);
            # time.sleep(0.8)
